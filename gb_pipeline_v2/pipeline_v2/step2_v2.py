...
STEP2_VALIDATION_FALLBACK_MODEL = "gpt-5.4"
...
def build_openai_request_payload(prompt_text: str, model: str = "gpt-5.4", reasoning_effort: str = "medium") -> Dict[str, Any]:
    return {
        "model": model,
        "input": prompt_text,
...
def synthesize_existing_step2_outputs(
    ...
    *,
    ...
    result_payload = merge_window_mappings(
