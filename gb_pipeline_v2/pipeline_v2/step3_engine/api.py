...
def resolve_runtime_options(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    return {
        ...
        "openai_base_url": config_values.get("openai_base_url"),
    }
...
def build_synonym_maps(
    ...
    for item in items:
        ...
        bridge_names = dedupe_preserve_order([canonical_name] + aliases)
...
def rank_candidate_components(
    ...
    special_candidates = set(SPECIAL_ITEM_COMPONENTS.get(query_name, []))
